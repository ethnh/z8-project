...
const Pricing = () => {
    ...
    return (
        <div className="flex gap-8 my-10 p-7">
            <Container className={'bg-white hover:bg-gradient-to-b from-[#DFEEF4] to-white cursor-pointer'}>
            ...
            <Container className={'bg-white duration-300 hover:bg-gradient-to-b from-[#DFEEF4] to-white cursor-pointer'}>
